...
enum AppFont {
    ...
    static let title2       = Font.custom(montserrat.black.weight,      size: 20)
    ...
    static let body2         = Font.custom(montserrat.bold.weight,       size: 14)
    static let body3        = Font.custom(montserrat.medium.weight,     size: 12)
